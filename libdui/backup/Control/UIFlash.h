...
// \Utils\Flash11.tlb 为Flash11接口文件，部分方法在低版本不存在，使用需注意
	...
	#import "..\Utils/Flash18.tlb" raw_interfaces_only, named_guids  
...
#else                  //vs2013  
//	#import "../Utils/Flash18.tlb" raw_interfaces_only, named_guids, rename("IDispatchEx", "IMyDispatchEx"), rename("ICanHandleException", "IMyICanHandleException")
